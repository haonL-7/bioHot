...
try:
    ...
    print(f"  Avg Forward (Microbe->Host): {s.get('avg_forward', s.get('avg_effectiveness', 'N/A'))}")
    print(f"  Avg Reverse (Host->Microbiome): {s.get('avg_reverse', s.get('avg_safety', 'N/A'))}")
